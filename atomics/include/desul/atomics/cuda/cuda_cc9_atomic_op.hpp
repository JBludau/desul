...
device_atomic_##OP (ctype* dest, ctype val, DESUL_IMPL_CUDA_128BIT_MEMORY_ORDER, DESUL_IMPL_CUDA_128BIT_MEMORY_SCOPE) \
{                                                                                                                         \
  device_atomic_fetch_##OP (dest,val, DESUL_IMPL_CUDA_128BIT_MEMORY_ORDER(), DESUL_IMPL_CUDA_128BIT_MEMORY_SCOPE());       \
} 
